 ...
 * Tela de Cadastro de Área Compartilhada Edifício
 */
package view.Cadastro;

/**
 * Tela de cadastro de Área Compartilhada Edifício (associação).
 * Campos: id, observacao, status
 * @author aluno
 */
public class TelaCadastroAreaCompartilhadaEdificio extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de Área Compartilhada Edifício");
        setResizable(false);
        ...
        jLabeltitulo.setText("Área Compartilhada Edifício");
