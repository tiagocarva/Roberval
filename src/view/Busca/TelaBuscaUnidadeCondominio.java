 ...
 * @author aluno
 */
public class TelaBuscaUnidadeCondominio extends javax.swing.JDialog {

    public TelaBuscaUnidadeCondominio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Busca de Unidades do Condomínio");
        ...
        if (jTableDados.getColumnModel().getColumnCount() > 0) {
            ...
            jTableDados.getColumnModel().getColumn(1).setMinWidth(400);
        ...
        jComboFiltrar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Status" }));
        ...
        jComboOrdenar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Status" }));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaUnidadeCondominio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaUnidadeCondominio dialog = new TelaBuscaUnidadeCondominio(new javax.swing.JFrame(), true);
