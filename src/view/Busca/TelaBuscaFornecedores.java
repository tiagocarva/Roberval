 ...
 * @author aluno
 */
public class TelaBuscaFornecedores extends javax.swing.JDialog {

    public TelaBuscaFornecedores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Tipo de Pessoa", "CNPJ", "CPF", "Nome Fantasia"
            }
        ));
        ...
        if (jTableDados.getColumnModel().getColumnCount() > 0) {
            ...
            jTableDados.getColumnModel().getColumn(1).setMinWidth(80);
            ...
            jTableDados.getColumnModel().getColumn(4).setMinWidth(130);
            jTableDados.getColumnModel().getColumn(4).setMaxWidth(130);
        }
        ...
        jComboFiltrar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Tipo de Pessoa", "CNPJ", "CPF", "Nome Fantasia" }));
        ...
        jComboOrdenar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Tipo de Pessoa", "CNPJ", "CPF", "Nome Fantasia" }));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaFornecedores dialog = new TelaBuscaFornecedores(new javax.swing.JFrame(), true);
