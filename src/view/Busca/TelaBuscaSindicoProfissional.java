...
public class TelaBuscaSindicoProfissional extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        if (jTableDados.getColumnModel().getColumnCount() > 0) {
            ...
            jTableDados.getColumnModel().getColumn(1).setMinWidth(100);
            jTableDados.getColumnModel().getColumn(1).setMaxWidth(100);
            jTableDados.getColumnModel().getColumn(2).setMinWidth(125);
            jTableDados.getColumnModel().getColumn(2).setMaxWidth(125);
            jTableDados.getColumnModel().getColumn(3).setMinWidth(175);
            jTableDados.getColumnModel().getColumn(3).setMaxWidth(175);
        }
        ...
        jComboFiltrar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "CPF", "CNPJ", "Nome Fantasia" }));
        ...
        jComboOrdenar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "CPF", "CNPJ", "Nome Fantasia" }));
