...
public class TelaBuscaAreaCompartilhadaEdificio extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Busca de Áreas Compartilhadas por Edifício");
        ...
        jComboFiltrar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id" }));
        ...
        jComboOrdenar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id" }));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaAreaCompartilhadaEdificio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
